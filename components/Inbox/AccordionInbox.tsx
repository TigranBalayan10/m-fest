        ...
        <Accordion type="single" collapsible>
            <AccordionItem value="inbox">
                <AccordionTrigger className="flex justify-start gap-2 rounded-md px-3 py-2 text-gray-700 transition-colors hover:bg-gray-200">
                    <FaMessage />
                    Messages
                    {isLoading || error ? null : <span className="ml-auto inline-flex items-center justify-center bg-red-500 text-white rounded-full px-2 py-1 text-xs font-semibold no-underline">
