                ...
                <div className="flex items-center gap-4">
                    ...
                    <nav className="hidden md:flex">
                        <ul className="flex items-center gap-4">
                            <li>
                                <Link className="rounded-md px-3 py-2 transition-colors hover:bg-gray-800" href="dashboard/overview">
                                    Overview
                                </Link>
                            </li>
                            <li>
                                <Link className="rounded-md px-3 py-2 transition-colors hover:bg-gray-800" href="/dashboard/analytics">
                                    Analytics
                                </Link>
                            </li>
                            <li>
